...
> **Remarque** : Some JavaScript libraries such as Backbone may send input to the application as JSON. You may access this data via `Input::get` like normal.
...
> **Remarque** : You may flash other data across requests using the [Session](../services/session) class.
