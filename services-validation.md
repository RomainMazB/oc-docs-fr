...
> **Remarque** : By default, messages are formatted using Bootstrap compatible syntax.
...
> **Remarque** : This function uses PHP's `filter_var` method.
...
> **Remarque** : The `$input` parameter passed to your `Closure` will be an instance of `Illuminate\Support\Fluent` and may be used as an object to access your input and files.
