...
L'afficheur tableau de scores est généralement utilisé avant une liste pour afficher une vue d'ensemble des données les plus importantes.
L'afficheur peut être formé de n'importe quel graphique et indicateur.
...
> **Remarque** : l'exemple est donné dans un contexte où il est intégré à un d'un tableau de scores. Si vous utilisez un indicateur dans un partiel de [widget de rapport](widgets#report-widgets), la class **scoreboard-item** ne devrait pas être utilisée.
